...
<head>
    ...
    <link href="//cdn.datatables.net/colvis/1.1.2/css/dataTables.colVis.css">
    <script src="//cdn.datatables.net/colvis/1.1.2/js/dataTables.colVis.min.js"></script>
    <link href="//cdn.datatables.net/responsive/1.0.6/css/dataTables.responsive.css" />
...
<div style="width: 80%; margin: auto;">
    ...
    <?php if($group): ?>
        <form action="<?= action('Barryvdh\TranslationManager\Controller@postAdd', array($group)) ?>" method="POST"  role="form" hidden>
